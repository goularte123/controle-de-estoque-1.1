...
*/
$url = 'http://localhost/Controle-Estoque//views/';
...
$header = '<header class="main-header">
    ...
    <a href="' . $url . '" class="logo">
      ...
      <span class="logo-lg"><b>Controle</b> De Estoque</span>
    </a>
            ...
            <ul class="dropdown-menu">
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="' . $url . 'dist/img/kayn-160x160.jpg" class="img-circle" alt="User Image">
                      </div>
